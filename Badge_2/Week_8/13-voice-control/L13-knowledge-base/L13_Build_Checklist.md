# DACE Lesson Build Checklist - L13
...
- **Competency Code:** 2D (Voice Control)
...
|----------|--------|------|
| Learning Objectives | ✅ | [L13_voice_control_learning_objectives.md](./knowledge-base/curriculum-development/L13_voice_control_learning_objectives.md) |
| Lesson Plan | ✅ | [L13_voice_control_lesson_plan.md](./knowledge-base/curriculum-development/L13_voice_control_lesson_plan.md) |
| Figma Build Guide | ✅ | [L13_voice_control_figma_build_guide.md](./knowledge-base/curriculum-development/L13_voice_control_figma_build_guide.md) |
| Quiz Questions | ✅ | [L13_Quiz_Questions.md](./L13_Quiz_Questions.md) |

### Implementation Files (Phase 2)
| Document | Status | Link |
|----------|--------|------|
| Canvas Page | ✅ | [L13-voice-control.html](../../canvas-pages/L13-voice-control.html) |
| Quiz QTI | ✅ | [L13_voice_control_quiz.qti.zip](./L13_voice_control_quiz.qti.zip) |
...
| L12 Canvas Page (predecessor) | *(L12 not yet built)* |
| L11 Canvas Page (reference) | [L11-sr-navigation-patterns.html](../../canvas-pages/L11-sr-navigation-patterns.html) |
...
- [x] Create [L13_voice_control_learning_objectives.md](./knowledge-base/curriculum-development/L13_voice_control_learning_objectives.md)
...
### 1.2 Lesson Plan
- [x] Create [L13_voice_control_lesson_plan.md](./knowledge-base/curriculum-development/L13_voice_control_lesson_plan.md)
...
- [x] Create [L13_voice_control_figma_build_guide.md](./knowledge-base/curriculum-development/L13_voice_control_figma_build_guide.md)
...
### 1.4 Quiz Questions
- [x] Create [L13_Quiz_Questions.md](./L13_Quiz_Questions.md)
...
### 2.1 Canvas Page
- [x] Create [L13-voice-control.html](../../canvas-pages/L13-voice-control.html)
...
- [x] Save to [L13_voice_control_quiz.qti.zip](./L13_voice_control_quiz.qti.zip)
...
- [x] Copy content from `canvas-pages/L13-voice-control.html` (body content only)
...
├── Explainer-videos/
│   └── L13_voice_control_en-x-autogen.vtt
├── Canvas-Screens/
│   ├── lesson-13-canvas-page.png
│   ├── lesson-13-knowledge-check.png
│   └── lesson-13-module.png
├── Figma-Screens/
│   └── (exported slide images)
├── L13_Quiz_Questions.md
└── L13_Build_Checklist.md
```
...
| Quiz Questions | [L13_Quiz_Questions.md](./L13_Quiz_Questions.md) |
| Canvas Page | [L13-voice-control.html](../../canvas-pages/L13-voice-control.html) |
| Quiz QTI | [L13_Voice_Control_Quiz_QTI.zip](./L13_Voice_Control_Quiz_QTI.zip) |
