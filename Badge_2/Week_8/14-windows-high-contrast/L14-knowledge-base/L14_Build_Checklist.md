# DACE Lesson Build Checklist - L14
...
- **Lesson Number:** L14
- **Topic:** Windows High Contrast Mode
...
|----------|--------|------|
| Learning Objectives | ✅ | [L14_windows_high_contrast_learning_objectives.md](./knowledge-base/curriculum-development/L14_windows_high_contrast_learning_objectives.md) |
| Lesson Plan | ✅ | [L14_windows_high_contrast_lesson_plan.md](./knowledge-base/curriculum-development/L14_windows_high_contrast_lesson_plan.md) |
| Figma Build Guide | ✅ | [L14_windows_high_contrast_figma_build_guide.md](./knowledge-base/curriculum-development/L14_windows_high_contrast_figma_build_guide.md) |
| Quiz Questions | ✅ | [L14_Quiz_Questions.md](./L14_Quiz_Questions.md) |

### Implementation Files (Phase 2)
| Document | Status | Link |
|----------|--------|------|
| Canvas Page | ✅ | [L14-windows-high-contrast.html](../../canvas-pages/L14-windows-high-contrast.html) |
| Quiz QTI | ✅ | [qti-export/L14_Windows_High_Contrast_Quiz_QTI.zip](./qti-export/L14_Windows_High_Contrast_Quiz_QTI.zip) |
...
| L13 Canvas Page (predecessor) | [L13-voice-control.html](../../canvas-pages/L13-voice-control.html) |
...
- [x] Create [L14_windows_high_contrast_learning_objectives.md](./knowledge-base/curriculum-development/L14_windows_high_contrast_learning_objectives.md)
...
### 1.2 Lesson Plan
- [x] Create [L14_windows_high_contrast_lesson_plan.md](./knowledge-base/curriculum-development/L14_windows_high_contrast_lesson_plan.md)
...
- [x] Create [L14_windows_high_contrast_figma_build_guide.md](./knowledge-base/curriculum-development/L14_windows_high_contrast_figma_build_guide.md)
...
### 1.4 Quiz Questions
- [x] Create [L14_Quiz_Questions.md](./L14_Quiz_Questions.md)
...
### 2.1 Canvas Page
- [x] Create [L14-windows-high-contrast.html](../../canvas-pages/L14-windows-high-contrast.html)
...
- [x] Save to [qti-export/L14_Windows_High_Contrast_Quiz_QTI.zip](./qti-export/L14_Windows_High_Contrast_Quiz_QTI.zip)
...
- [x] Copy content from `canvas-pages/L14-windows-high-contrast.html` (body content only)
...
├── Explainer-videos/
│   └── L14_windows_high_contrast_en-x-autogen.vtt
├── Canvas-Screens/
│   ├── lesson-14-canvas-page.png
│   ├── lesson-14-knowledge-check.png
│   └── lesson-14-module.png
├── Figma-Screens/
│   └── (exported slide images)
├── L14_Quiz_Questions.md
└── L14_Build_Checklist.md
```
...
| Quiz Questions | [L14_Quiz_Questions.md](./L14_Quiz_Questions.md) |
| Canvas Page | [L14-windows-high-contrast.html](../../canvas-pages/L14-windows-high-contrast.html) |
| Quiz QTI | [L14_Windows_High_Contrast_Quiz_QTI.zip](./L14_Windows_High_Contrast_Quiz_QTI.zip) |
