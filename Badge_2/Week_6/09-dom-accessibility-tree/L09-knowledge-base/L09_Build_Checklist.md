# DACE Lesson Build Checklist - L09
...
- **Lesson Number:** L09
- **Topic:** DOM & Accessibility Tree
- **Badge Level:** [ ] Discover | [X] Define | [ ] Deliver
- **Competency Code:** 2A (DOM/Accessibility Tree)
...
|----------|--------|------|
| Learning Objectives | ✅ | [L09_dom_accessibility_tree_learning_objectives.md](./knowledge-base/curriculum-development/L09_dom_accessibility_tree_learning_objectives.md) |
| Lesson Plan | ✅ | [L09_dom_accessibility_tree_lesson_plan.md](./knowledge-base/curriculum-development/L09_dom_accessibility_tree_lesson_plan.md) |
| Figma Build Guide | ✅ | [L09_dom_accessibility_tree_figma_build_guide.md](./knowledge-base/curriculum-development/L09_dom_accessibility_tree_figma_build_guide.md) |
| Quiz Questions | ✅ | [L09_Quiz_Questions.md](./L09_Quiz_Questions.md) |

### Implementation Files (Phase 2)
| Document | Status | Link |
|----------|--------|------|
| Canvas Page | ✅ | [L09-dom-accessibility-tree.html](../../canvas-pages/L09-dom-accessibility-tree.html) |
| Quiz QTI | ✅ | [L09_DOM_Accessibility_Tree_Quiz_QTI.zip](./L09_DOM_Accessibility_Tree_Quiz_QTI.zip) |
...
- [x] Create [L09_dom_accessibility_tree_learning_objectives.md](./knowledge-base/curriculum-development/L09_dom_accessibility_tree_learning_objectives.md)
...
### 1.2 Lesson Plan
- [x] Create [L09_dom_accessibility_tree_lesson_plan.md](./knowledge-base/curriculum-development/L09_dom_accessibility_tree_lesson_plan.md)
...
- [x] Create [L09_dom_accessibility_tree_figma_build_guide.md](./knowledge-base/curriculum-development/L09_dom_accessibility_tree_figma_build_guide.md)
...
### 1.4 Quiz Questions
- [x] Create [L09_Quiz_Questions.md](./L09_Quiz_Questions.md)
...
### 2.1 Canvas Page
- [x] Create [L09-dom-accessibility-tree.html](../../canvas-pages/L09-dom-accessibility-tree.html)
...
- [x] Save to [L09_DOM_Accessibility_Tree_Quiz_QTI.zip](./L09_DOM_Accessibility_Tree_Quiz_QTI.zip)
...
- [x] Copy content from `canvas-pages/L09-dom-accessibility-tree.html` (body content only)
...
- [x] DACE site learning objectives page screenshot (if applicable)

### 6.2 Files to Archive
- [x] Explainer video captions (.vtt)
- [x] Exported Figma slides (images)
- [x] Canvas page screenshots
- [x] DACE site screenshots

### Archive Folder Structure
📁 [09-dom-accessibility-tree/](./)
```
├── knowledge-base/
│   └── curriculum-development/
├── Explainer-videos/
│   └── L09_dom_accessibility_tree_en-x-autogen.vtt
├── Canvas-Screens/
│   ├── lesson-09-canvas-page.png
│   ├── lesson-09-knowledge-check.png
│   └── lesson-09-module.png
├── Figma-Screens/
│   └── (exported slide images)
├── L09_Quiz_Questions.md
└── L09_Build_Checklist.md
```
