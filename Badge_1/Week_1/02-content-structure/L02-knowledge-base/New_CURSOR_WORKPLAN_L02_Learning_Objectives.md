  ...
  02-content-structure/
    knowledge-base/
      curriculum-development/
        L02_headings_learning_objectives.md
```

### Task 2: Update the Master Reference

**File:** `DACE_Master_Reference.md`

**Location:** Section 3 (Module Learning Objectives), between current Section 3.1 (L01) and Section 3.2 (L03)

**Action:** Insert the new Section 3.2 for L02, then renumber L03 to become Section 3.3

**Find this line (approximately line 641):**
```markdown
## 3.2 L03: Color
```
...
### Task 3: Update Table of Contents (if present)

If the Master Reference has a detailed table of contents listing subsections, update it to reflect:
- 3.1 L01: Accessible Names
- 3.2 L02: Headings and Reading Order (NEW)
- 3.3 L03: Color (renumbered)

### Task 4: Update Document Completion Summary

**Find (approximately line 1844):**
```markdown
âœ… **Module Learning Objectives** (Section 3)
...
âœ… **Module Learning Objectives** (Section 3)
- L01: Accessible Names (all three badge levels)
- L02: Headings and Reading Order (all three badge levels)
- L03: Color (complete with pedagogical notes)
```
...
- Any other sections not mentioned above
