...
**Quiz (5 points):**
- 5 multiple choice questions testing hierarchy rules and platform differences
...
| Q2 | 1B.01 | Modal dialog heading levels |
| Q3 | 1B.02 | Multi-platform annotation approach |
| Q4 | 1B.01 | Identifying what should be a heading (tagline example) |
| Q5 | 1B.01 | Identifying what should be a heading (product landing page) |

**Note:** Reading order questions have been moved to L05: Keyboard, Touch & Reading Order.
